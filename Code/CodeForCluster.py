...
Node = 16
age = 120                  # Max age of network in normal balance
iterate = 2000             # it depends on nodes and age, for normal balance
ensemble = 1
std = 1                    # constant for all of them but  WHY?!
